...
export declare const isLengthPercentage: (token: CSSValue) => token is NumberValueToken | DimensionToken;
export declare const parseLengthPercentageTuple: (tokens: (NumberValueToken | DimensionToken)[]) => LengthPercentageTuple;
...
export declare const getAbsoluteValue: (token: NumberValueToken | DimensionToken, parent: number) => number;
